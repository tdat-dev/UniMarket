    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex flex-1 w-full">
            ...
            <div class="hidden lg:flex lg:w-1/2 bg-blue-50 items-center justify-center relative overflow-hidden">
                <div class="w-3/4">
                    <img src="../../../images/homepage-with-text.png" alt="register image"
            ...
            <div
                class="w-full lg:w-1/2 flex flex-col items-center justify-center p-8 bg-white shadow-lg lg:shadow-none">
                    ...
                    <form action="" method="post" class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <span
                                ...
                                id="togglePasswordRegister">👁️</span>
                        </div>

                        <input type="submit" name="submit" value="ĐĂNG KÝ"
                            class="w-full bg-blue-600 text-white font-bold py-3 rounded-lg hover:bg-blue-700 transition duration-300 cursor-pointer">
                        ...
                        <a href=""
                            class="flex items-center justify-center w-full border border-gray-300 py-3 rounded-lg hover:bg-gray-50 transition duration-300">
                            <img src="../../../images/google.png" alt="Google" class="w-5 h-5 mr-2">
                            <span class="text-gray-700 font-medium">Google</span>
                        </a>

                        <div class="text-center mt-6">
                            <p class="text-gray-600">Đã có tài khoản? <a href="../login"
                                    class="text-blue-600 font-bold hover:underline">Đăng nhập</a></p>
                        </div>
                    </form>
                </div>
            </div>
