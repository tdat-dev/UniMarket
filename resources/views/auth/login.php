...
<head>
    ...
    <title>Đăng nhập - UniMarket</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700;900&display=swap" rel="stylesheet">
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
    body { font-family: 'Roboto', sans-serif; }
    .no-drag { -webkit-user-drag: none; user-drag: none; -webkit-user-select: none; user-select: none; pointer-events: none; }
    </style>
</head>
        ...
        <div class="w-full max-w-[1400px] mx-auto px-4 flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div class="w-full lg:w-[40%] max-w-[450px] bg-white rounded-3xl shadow-2xl p-8 md:p-10">
                <div class="text-center mb-6">
                    <img src="/images/LogoHeader.png" alt="UniMarket Logo" class="h-16 mx-auto mb-4 no-drag object-contain">
                ...
                <form action="" method="post" class="space-y-4">
                    <div>
                        <input type="text" name="username" placeholder="Email hoặc Số điện thoại" required value="<?php echo isset($_POST['username']) ? htmlspecialchars($_POST['username']) : '' ?>"
                    ...
                    <div class="text-center mt-6">
                        <p class="text-gray-500 text-sm">Chưa có tài khoản? <a href="register.php" class="text-[#5A88FF] font-bold hover:underline">Đăng ký ngay</a></p>
                    </div>
                </form>
            </div>
        </div>
