    ...
    <div class="max-w-[1200px] mx-auto px-4 pt-4">
        ...
        <?php if (empty($products)): ?>
            <div class="bg-white rounded-sm shadow-sm p-10 text-center">
                ...
                <a href="/products" class="inline-block px-6 py-2 bg-[#EE4D2D] text-white rounded-sm hover:bg-[#d73211] transition-colors">
                    Mua ngay
                </a>
            </div>
        <?php else: ?>
            <form id="cart-form" action="/checkout" method="POST" class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-8 space-y-4">
                    <div class="bg-white rounded-sm shadow-sm overflow-hidden">
                        <!-- Header -->
                        <div class="grid grid-cols-12 gap-4 p-4 border-b bg-gray-50 text-sm text-gray-500 font-medium items-center">
                            <div class="col-span-1 flex justify-center">
                                <input type="checkbox" id="check-all" class="w-4 h-4 text-[#EE4D2D] border-gray-300 rounded focus:ring-[#EE4D2D]">
                            </div>
                        ...
                        <div class="cart-item grid grid-cols-12 gap-4 p-4 border-b last:border-0 items-center hover:bg-gray-50/50 transition-colors" 
                            ...
                            <div class="col-span-5 flex gap-3">
                                ...
                                <div class="flex flex-col justify-center">
                                    <a href="/product-detail?id=<?= $item['id'] ?>" class="text-sm font-medium text-gray-800 line-clamp-2 hover:text-[#2C67C8]">
                            ...
                            <div class="col-span-2 flex justify-center items-center">
                                <div class="flex items-center border border-gray-300 rounded-sm">
                                    <button type="button" class="w-8 h-8 flex items-center justify-center bg-gray-50 hover:bg-gray-200 text-gray-600 focus:outline-none" onclick="updateQuantity(<?= $item['id'] ?>, -1)">
                                        <i class="fa-solid fa-minus text-xs"></i>
                                    </button>
                                    <input type="text" value="<?= $item['cart_quantity'] ?>" 
                                           class="w-10 h-8 text-center text-sm border-l border-r border-gray-300 focus:outline-none text-gray-800" readonly>
                                    <button type="button" class="w-8 h-8 flex items-center justify-center bg-gray-50 hover:bg-gray-200 text-gray-600 focus:outline-none" onclick="updateQuantity(<?= $item['id'] ?>, 1)">
                ...
                <div class="lg:col-span-4">
                    <div class="bg-white rounded-sm shadow-sm p-6 sticky top-4">
                        ...
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <span class="font-medium" id="summary-subtotal"><?= number_format($grandTotal, 0, ',', '.') ?>đ</span>
                        </div>
                        ...
                        <div class="flex justify-between items-center mb-6 pt-4 border-t">
                            ...
                            <span class="text-xl font-bold text-[#EE4D2D]" id="summary-total"><?= number_format($grandTotal, 0, ',', '.') ?>đ</span>
                        </div>

                        <button type="submit" id="btn-buy" class="w-full py-3 bg-[#EE4D2D] text-white font-bold rounded-sm hover:bg-[#d73211] transition-transform active:scale-[0.98] shadow-md disabled:bg-gray-400 disabled:cursor-not-allowed">
