                    ...
                    <div class="flex gap-4 pt-4">
                        <?php if ($product['quantity'] > 0 && $product['status'] === 'active'): ?>
                            <form action="/cart/add" method="POST" class="flex gap-4 w-full">
                                ...
                                <button type="submit" name="action" value="add" class="flex-1 px-6 py-3 bg-[#2C67C8] text-white font-medium rounded-sm hover:bg-[#F97316] transition-colors flex items-center justify-center gap-2">
                                    <i class="fa-solid fa-cart-shopping"></i> Thêm vào giỏ hàng
                                </button>
                                <button type="submit" name="action" value="buy" class="flex-1 px-8 py-3 bg-[#2C67C8] text-white font-medium rounded-sm hover:bg-[#F97316] transition-colors shadow-sm text-center">
                                    Mua ngay
                                </button>
                            </form>
                        <?php else: ?>
