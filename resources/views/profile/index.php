            ...
            <form action="/profile/update" method="POST" class="max-w-3xl">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="address" value="<?= htmlspecialchars($_SESSION['user']['address'] ?? '') ?>" placeholder="Nhập địa chỉ nhận hàng của bạn" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
